...
const date_1 = __nccwpck_require__(545);
const getVersion = async (expireInDays) => {
    const expDaysNumber = parseInt(expireInDays);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.OUTPUT_VERSION = exports.INPUT_EXPIRE_IN_DAYS = void 0;
// Inputs
exports.INPUT_EXPIRE_IN_DAYS = 'expire-in-days';
// Outputs
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(186));
const inOut = __importStar(__nccwpck_require__(126));
const get_version_1 = __nccwpck_require__(192);
/**
...
async function run() {
    try {
        ...
        const expireInDays = core.getInput(inOut.INPUT_EXPIRE_IN_DAYS, {
            required: true
        });
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.formatDate = exports.addToCurrentDate = void 0;
/**
 ...
 */
const addToCurrentDate = (daysToAdd) => {
    return new Date(Date.now() + daysToAdd * 3600 * 1000 * 24);
};
exports.addToCurrentDate = addToCurrentDate;
/**
